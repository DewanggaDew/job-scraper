  ...
  return (
    <form method="GET" className="flex items-center gap-1.5">
      ...
      <select
        ...
        // Auto-submit via a hidden button triggered by onChange
      >
        {options.map((opt) => (
      ...
      {/* Hidden submit button — triggered by JS onChange */}
      <noscript>
        <button type="submit" className="px-2 py-1.5 text-xs bg-green-600 text-white rounded-md">Go</button>
      </noscript>
    </form>
  )
}
